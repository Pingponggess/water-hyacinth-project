...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct  2 15:23:42 2023
...
def reset_game():
    global triangles, ship_pos, total_displacement, eliminated_triangles, direction, rotation_angle, rotation_angle_previous, total_rotation_angle, triangle_generations, collected_triangles

    triangles = [(random.randint(0, WIDTH - TRIANGLE_SIZE), random.randint(TRIANGLE_SIZE, HEIGHT - TRIANGLE_SIZE)) for _ in range(100)]
...
#                    triangle_generations += 1
    ...
    if len(triangles) == 0:  # When no triangles left
