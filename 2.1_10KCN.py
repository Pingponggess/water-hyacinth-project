...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct  2 16:40:06 2023
...
def reset_game():
    global triangles, ship_pos, total_displacement, eliminated_triangles, direction, rotation_angle, rotation_angle_previous, total_rotation_angle, triangle_generations, triangle_colors
        ...
        if event.type == QUIT:
            ...
            if triangle_generations < 5:
                if len(triangles) < 110:
                    ...
                    new_triangle_colors = [find_nearest_triangle_color(new_triangle, triangles, triangle_colors) for new_triangle in new_triangles]
                    triangle_colors.extend(new_triangle_colors)
